...
<html>
    <head>
        ...
        <title>Customer Manage profile. Page</title>
    ...
    <body>
        ...
        <div class="container col-md-5 my-5">
            <div class="card">
                <div class="card-body">
                    <form action="CustomerManageProfile" method="post">
                        ...
                        <%
                            ...
                            try {
                                ...
                                String sql = "SELECT * FROM `customer_info_tb`, `cust_addr_tb` WHERE `customer_info_tb`.`Customer ID` = "+id+" AND `cust_addr_tb`.`Cust_Addr_ID` = "+id+";";
